...
while(ret):
	...
	# 				if avg_counter > 20:
	# 					avg_glasses = max(set(wearing_glasses), key=wearing_glasses.count)
	...
	# 						shirt_brightness = "light"
	# 					else:
	# 						shirt_brightness = "dark"
	# 					print(looking_for[looking_for_count])
	# 					if looking_for[looking_for_count] == "glasses" and avg_glasses:
	# 						test_pass = True
	...
	# 						test_pass = True
	# 					elif looking_for[looking_for_count] == "light_shirt" and shirt_brightness == "light":
	# 						test_pass = True
	# 					elif looking_for[looking_for_count] == "dark_shirt" and shirt_brightness == "dark":
	# 						test_pass = True
	# 					if test_pass:
	...
	# 						# padded_img = resizeAndPad(portrait_img, (save_height, save_height * .8), 0)
	...
	# 						if num_of_pics >= 1:
	# 							print("increasing looking index")
	# 							looking_for_count += 1
	# 							if looking_for_count  >= len(looking_for):
	# 								looking_for_count = 0
	# 							num_of_pics = 0
	# 							print("update ", looking_for_count)
	# 					# exit the loop
	# 					# ret = False
	# 					# Reset everything
	# 					avg_counter = 0
